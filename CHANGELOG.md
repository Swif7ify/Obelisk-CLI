...
> 🚀 **Official Release** — AI-powered code health and analysis.

    ### Added
    - Complete UI redesign for the interactive TUI
    - Refined component architecture and scorecard rendering
    - Streamlined MCP server documentation for local stdio integration
...
- Interactive TUI with Bubble Tea — interactive visual menu system
